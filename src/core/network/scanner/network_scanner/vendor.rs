pub fn get_vendor_from_mac(mac: &str) -> Option<String> {
    ...
    match oui_prefix {
        ...
        // HomeKit Hubs (Apple TV, HomePod, iPad acting as hub)
        ...
        // Amazon/Alexa devices & Echo devices
        ...
        // Raspberry Pi (often used for smart home hubs)
        ...
        // Additional smart home & IoT devices
