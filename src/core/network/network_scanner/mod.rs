...
use crate::core::network::network_scanner::discovery::{
    discover_device_name, discover_mdns_devices, perform_reverse_dns_lookup,
};
use crate::core::network::network_scanner::network::{
    get_default_gateway, scan_local_network_interfaces,
};
use crate::core::network::network_scanner::types::LocalNetworkDevice;
use crate::core::network::network_scanner::vendor::get_vendor_from_mac;
use ipnet::IpNet;
